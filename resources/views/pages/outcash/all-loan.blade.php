...
@section('body')
  <section class="content-header">
      <h1>
        Outcash
        <small>View All Outcash</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="/outcash">Outcash</a></li>
        <li class="active">All Outcash</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-solid ">
            <div class="box-header">
              ...
              <h3 class="box-title">Monthly Loan Chart</h3>
